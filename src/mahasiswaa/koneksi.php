...
class database{
    ...
    function tambah_data($npm,$nama_mhs,$alamat)
    {
    mysqli_query($this->koneksi,"insert mahasiswa values ('','$npm','$nama_mhs','$alamat')");
    }
	...
	function update_data($npm,$nama_mhs,$alamat,$id_mhs)
	{
